            ...
            <div className="row align-items-center px-3">
                ...
                <div className="col-md-10 col-8 header-right d-flex justify-content-end align-items-center">
                    <div className="d-flex flex-column">
                        ...
                        <span className="d-md-none header-title mr-2" data-testid="mobile-title">{title}</span>
                    </div>

                    <span className="d-none d-md-block header-title" data-testid="desktop-title">{title}</span>
